...
namespace QuanLyBanHang.Forms
{
    public partial class frmHangSanXuat : Form
    {
                    ...
                    using (XLWorkbook workbook = new XLWorkbook(openFileDialog.FileName))
                    {
                        ...
                        if (table.Rows.Count > 0)
                        {
                            foreach (DataRow r in table.Rows)
                            {
                                ...
                                // Lưu ý: Tên cột trong file Excel phải là "TenHangSanXuat"
        ...
        private void btnXuat_Click(object sender, EventArgs e)
        {
            ...
            // Đổi tên file xuất ra thành HangSanXuat
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    table.Columns.AddRange(new DataColumn[2] {
                        ...
                        new DataColumn("TenHangSanXuat", typeof(string)) // Đổi tên cột
                    });

                    // Lấy dữ liệu từ bảng HangSanXuat
                    var hangSanXuat = context.HangSanXuat.ToList();
                    if (hangSanXuat != null)
                    {
                        foreach (var p in hangSanXuat)
                            table.Rows.Add(p.ID, p.TenHangSanXuat); // Thêm dữ liệu vào table
                    }
